...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgCData(oldp+0,(vlSelf->mic_signal),8);
    bufp->chgBit(oldp+1,(vlSelf->wr));
    bufp->chgBit(oldp+2,(vlSelf->rd));
    bufp->chgSData(oldp+3,(vlSelf->offset),9);
    bufp->chgCData(oldp+4,(vlSelf->delayed_signal),8);
    bufp->chgBit(oldp+5,(vlSelf->_clk));
    bufp->chgBit(oldp+6,(vlSelf->_rst));
    bufp->chgSData(oldp+7,(vlSelf->sigdelay__DOT___count),9);
    bufp->chgSData(oldp+8,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT___count) 
