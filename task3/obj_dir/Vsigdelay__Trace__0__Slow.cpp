...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"delayed_signal", false,-1, 7,0);
    ...
    tracep->declBus(c+10,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+11,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+8,"wraddr", false,-1, 8,0);
    tracep->declBus(c+9,"raddr", false,-1, 8,0);
    tracep->declBus(c+1,"din", false,-1, 7,0);
    tracep->declBit(c+6,"clk", false,-1);
    tracep->declBit(c+2,"wren", false,-1);
    tracep->declBit(c+3,"ren", false,-1);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->delayed_signal),8);
    bufp->fullBit(oldp+6,(vlSelf->_clk));
    bufp->fullBit(oldp+7,(vlSelf->_rst));
    bufp->fullSData(oldp+8,(vlSelf->sigdelay__DOT___count),9);
    bufp->fullSData(oldp+9,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT___count) 
