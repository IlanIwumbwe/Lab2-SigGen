...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sinegen__DOT___count = vlSelf->sinegen__DOT___count;
    vlSelf->__Vdly__sinegen__DOT___count = ((IData)(vlSelf->_rst)
                                             ? 0U : 
                                            (0xffU 
...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__1(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->_dout1 = vlSelf->sinegen__DOT__Rom__DOT__rom_array
        [vlSelf->sinegen__DOT___count];
    vlSelf->_dout2 = vlSelf->sinegen__DOT__Rom__DOT__rom_array
        [(0xffU & ((IData)(vlSelf->sinegen__DOT___count) 
                   + (IData)(vlSelf->_phase)))];
}
...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__2(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->sinegen__DOT___count = vlSelf->__Vdly__sinegen__DOT___count;
}
