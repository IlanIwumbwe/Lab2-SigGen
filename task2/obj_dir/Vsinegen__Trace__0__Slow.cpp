...
VL_ATTR_COLD void Vsinegen___024root__trace_init_sub__TOP__0(Vsinegen___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"addr1", false,-1, 7,0);
...
VL_ATTR_COLD void Vsinegen___024root__trace_full_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->_clk));
    bufp->fullBit(oldp+2,(vlSelf->_rst));
    bufp->fullBit(oldp+3,(vlSelf->_en));
    bufp->fullCData(oldp+4,(vlSelf->sinegen__DOT___count),8);
    bufp->fullCData(oldp+5,((0xffU & ((IData)(vlSelf->sinegen__DOT___count) 
                                      + (IData)(vlSelf->_phase)))),8);
    bufp->fullCData(oldp+6,(vlSelf->_dout1),8);
    bufp->fullCData(oldp+7,(vlSelf->_dout2),8);
