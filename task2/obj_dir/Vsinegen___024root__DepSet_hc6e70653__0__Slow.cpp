...
VL_ATTR_COLD void Vsinegen___024root___ctor_var_reset(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->_phase = VL_RAND_RESET_I(8);
    vlSelf->_rst = VL_RAND_RESET_I(1);
    vlSelf->_en = VL_RAND_RESET_I(1);
    vlSelf->_clk = VL_RAND_RESET_I(1);
    vlSelf->_dout1 = VL_RAND_RESET_I(8);
    vlSelf->_dout2 = VL_RAND_RESET_I(8);
    vlSelf->sinegen__DOT___count = VL_RAND_RESET_I(8);
    for (int __Vi0=0; __Vi0<256; ++__Vi0) {
        vlSelf->sinegen__DOT__Rom__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->__Vdly__sinegen__DOT___count = VL_RAND_RESET_I(8);
}
