...
void Vsinegen___024root__trace_chg_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+3,(vlSelf->sinegen__DOT___count),8);
    bufp->chgCData(oldp+4,((0xffU & ((IData)(vlSelf->sinegen__DOT___count) 
                                     + (IData)(vlSelf->_phase)))),8);
    bufp->chgCData(oldp+5,(vlSelf->_dout1),8);
    bufp->chgCData(oldp+6,(vlSelf->_dout2),8);
}
